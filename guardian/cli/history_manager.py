...
def update_stats_with_new_run(
    ...
    new_etes_run_components: ETESComponents, # Expects an object with attributes like ETESComponents
    ...
    if not isinstance(new_etes_run_components, ETESComponents):
        print("Warning: new_etes_run_components object is not of type ETESComponents. History entry might be incomplete or incorrect.")
